...
@patch(
    "gearcore_hub.update.update_all_mcp_servers",
    return_value=[{"id": "x", "message": "ok"}],
)
@patch(
    "gearcore_hub.update.update_all_skills",
    return_value=[{"name": "y", "message": "ok"}],
)
@patch(
    "gearcore_hub.vendor.update_superpowers",
    return_value={"changed": False, "upstream": "abc123"},
)
...
@patch(
    "gearcore_hub.update.update_mcp_server", return_value={"id": "x", "message": "ok"}
)
...
@patch(
    "gearcore_hub.vendor.update_superpowers",
    return_value={"changed": True, "upstream": "def4567890123"},
)
